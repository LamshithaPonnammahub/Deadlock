...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "glow-medical": "var(--glow-medical)",
        "glow-emergency": "var(--glow-emergency)",  
      ...
      keyframes: {
        ...
        "emergency-pulse": {
          "0%, 100%": { 
            boxShadow: "0 0 20px hsl(0 84% 60% / 0.7)",
          },
          "50%": { 
            boxShadow: "0 0 40px hsl(0 84% 60% / 0.9), 0 0 60px hsl(0 84% 60% / 0.5)",
          },
        },
        "float": {
